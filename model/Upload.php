...
class upload {
    ...
    $this->translation['file_error']                  = 'Erro de transmissão. Favor tentar novamente.';
    ...
    $this->translation['uploaded_too_big_ini']        = 'Erro ao carregar o arquivo (o arquivo carregado excede a directiva upload_max_filesize em php.ini).';
    $this->translation['uploaded_too_big_html']       = 'Erro ao carregar o arquivo (o arquivo carregado excede a directiva MAX_FILE_SIZE especificado no formulario html).';
    ...
    $this->translation['image_too_short']             = 'A imagem é muito curto.';
    $this->translation['ratio_too_high']              = 'O ratio é muito alto (Imagem muito larga).';
    $this->translation['ratio_too_low']               = 'O ratio é muito baixo (Imagem muito alta).';
    $this->translation['too_many_pixels']             = 'A imagem tem muitos pixels.';
    $this->translation['not_enough_pixels']           = 'A imagem tem poucos pixels.';
    $this->translation['file_not_uploaded']           = 'O arquivo não foi transmitido. Impossível continuar.';
    $this->translation['already_exists']              = '%s Ja existe. Favor mudar o nome do arquivo.';
    $this->translation['temp_file_missing']           = 'O arquivo fonte é incorreto. Impossível continuar.';
    $this->translation['source_missing']              = 'O arquivo transmitido é incorreto. Impossível continuar.';
    ...
    $this->translation['destination_path_not_dir']    = 'O path especificado não é um diretório. Impossível continuar.';
    $this->translation['destination_dir_write']       = 'Directorio de destino, sem permissão para editar. Impossível continuar.';
    $this->translation['destination_path_write']      = 'O path de destino não tem permissão de escrita ou não pode ser aberto. Impossível continuar.';
    ...
    $this->translation['create_error']                = 'Erro na criação da imagem %s desde o código fonte.';
    $this->translation['source_invalid']              = 'Impossível ler a imagem fonte. É uma imagem?.';
    $this->translation['gd_missing']                  = 'GD não parece estar presente.';
    $this->translation['watermark_no_create_support'] = 'Criação a partir do arquivo %s impossível, watermark não pode ser lido.';
    $this->translation['watermark_create_error']      = 'Erro no momento da criação do watermark %s desde o arquivo fonte.';
    $this->translation['watermark_invalid']           = 'Impossível ler o watermark, formato de arquivo desconhecido.';
    $this->translation['file_create']                 = 'Criação do arquivo %s impossível.';
